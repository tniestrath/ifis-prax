...
public class SubscriptionsController {
    ...
    @GetMapping("/custom")
    public String subCustom(String type, String thema, String author, String word, HttpServletRequest request) {return subService.subCustom(type, thema, author, word, request);}
