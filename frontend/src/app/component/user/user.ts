...
export class User extends DbObject {
  constructor(public override id: string = "",
              ...
              public redirectsLast30 : number = 0,
              public rankingContent : number = -1,
              public rankingContentTendency : boolean | null = null,
              public rankingContentByGroup : number = -1,
              public rankingContentByGroupTendency : boolean | null = null,
              public rankingProfile : number = -1,
              public rankingProfileTendency : boolean | null = null,
              public rankingProfileByGroup : number = -1,
              public rankingProfileByGroupTendency : boolean | null = null,
